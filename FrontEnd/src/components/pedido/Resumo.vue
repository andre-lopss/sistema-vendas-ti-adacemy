<template>
                        ...
                        <table class="table table-striped" v-else>
                            ...
                            <tbody v-for="(item, index) in ItensPedido" :key="index">
                                <tr>
                                    ...
                                    <td>{{ (item.valor * item.quantidade).toLocaleString("pt-br", {style: 'currency', currency: 'BRL'}) }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
    ...
    <div class="ps-0 container col-6" >  
        <router-link class="btn btn-primary mt-2 mb-2" to="/pedido/listar">Voltar</router-link>
    </div> 
</template>
